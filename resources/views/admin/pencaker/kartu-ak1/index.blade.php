...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            {{-- ================= STATISTIK RINGKAS ================= --}}
            {{-- Kalau mau aktifkan lagi, tinggal buka blok ini --}}
            {{--
            <div class="row mb-2">
            ...
            <div class="card-header bg-white border-bottom">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="mb-2 mb-md-0">
                        <small class="text-muted d-block mb-1">Nomor AK1</small>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-md-3 mb-2 mb-md-0">
                        ...
                        <button class="btn btn-danger btn-sm btn-block"
                            onclick="handleAjukan('{{ route('pencaker.ak1.submit', $item->id_kartu_ak1) }}')">
                    ...
                    <div class="col-12 col-md-3 mb-2 mb-md-0">
                        ...
                        <a href="{{ route('pencaker.ak1.cetak', $item->id_kartu_ak1) }}"
                            target="_blank"
                            class="btn btn-warning btn-sm btn-block">
                            <i class="fas fa-print mr-1"></i> Lihat & Cetak AK1
                        </a>
                        ...
                        <button class="btn btn-outline-secondary btn-sm btn-block" disabled
                            title="AK1 harus disetujui terlebih dahulu">
                            <i class="fas fa-print mr-1"></i> Lihat & Cetak AK1
                        </button>
