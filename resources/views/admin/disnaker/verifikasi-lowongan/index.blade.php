    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="d-flex align-items-center mb-2">
                <h1 class="mb-0">{{ $title ?? 'Verifikasi Lowongan' }}</h1>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline card-outline-tabs shadow-sm">
                ...
                <div class="card-body pt-3">
                    ...
                    @include('admin.disnaker.verifikasi-lowongan.partials.table', [
                    'lowongan' => $lowongan
                    ])
...
<script src="{{ asset('admin-js/disnaker-verifikasi-lowongan.js') }}"></script>
@endpush