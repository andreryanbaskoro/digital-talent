            ...
            <div class="card card-primary card-outline shadow-sm">
                ...
                <div class="card-header border-0 pb-0 d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="{{ route('perusahaan.laporan-lowongan.excel') }}"
                            class="btn btn-success btn-sm mr-2">
                            <i class="fas fa-file-excel"></i> Excel
                        </a>

                        <a href="{{ route('perusahaan.laporan-lowongan.pdf') }}"
                ...
                <div class="card-body pt-3">
                    ...
                    @include('admin.perusahaan.laporan-lowongan.partials.table', [
                    'lowongan' => $lowongan
                    ])
...
@push('scripts')
<script src="{{ asset('admin-js/perusahaan-laporan-lowongan.js') }}"></script>
...
<script>
    ...
    function openPrint(e) {
        ...
        iframe.src = "{{ route('perusahaan.laporan-lowongan.print') }}";
